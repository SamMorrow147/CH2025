export default function Menu({currentScroll}) {
    ...
    return (
        <div className={`${isEven(currentScroll) ? 'menu' : 'menu even'} ${currentScroll != 0 ? 'menu_active' : ''}`}>
            ...
            <div className="mobile_icon">
                ...
                <path class="cls-1" d="M190,9V36H13V9H190m1-1H12V37H191V8Z" transform="translate(-12 -8)"/>
                <rect x="0.5" y="50.53" width="178" height="27.97"/>
                <path class="cls-1" d="M190,59V86H13V59H190m1-1H12V87H191V58Z" transform="translate(-12 -8)"/>
                </svg>
            </div>
